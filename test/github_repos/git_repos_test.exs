defmodule GithubRepos.GitReposTest do
  use GithubRepos.DataCase
  ...
  describe "git_repos" do
    ...
    @valid_attrs %{fork: true, language: "some language", license: "some license", name: "some name", owner: "some owner", owner_url: "some owner_url", stars: 42, url: "some url"}
    @update_attrs %{fork: false, language: "some updated language", license: "some updated license", name: "some updated name", owner: "some updated owner", owner_url: "some updated owner_url", stars: 43, url: "some updated url"}
    @invalid_attrs %{fork: nil, language: nil, license: nil, name: nil, owner: nil, owner_url: nil, stars: nil, url: nil}
    ...
    test "create_git_repo/1 with valid data creates a git_repo" do
      ...
      assert git_repo.owner == "some owner"
    ...
    test "update_git_repo/2 with valid data updates the git_repo" do
      ...
      assert git_repo.owner == "some updated owner"
